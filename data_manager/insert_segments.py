...
class MutationDatabaseHandler:
    ...
    def __init__(self, metadata_file, fasta_file):
        ...
        # print("Prima di organize_files")
        self.organize_files(metadata_file, fasta_file)
        # print("Dopo di organize_files")
        self.execute_data_flow()
        # print("Dopo execute_data_flow")
        # print("self.dna_fasta_by_ref", self.dna_fasta_by_ref)
    ...
    def execute_data_flow(self):
        ...
        for key in self.dna_fasta_by_ref.keys():
            ...
            for annotation in annotations:
                ...
                # print("aligned_protein_fastas", len(aligned_protein_fastas))
            ...
            if line.startswith('>'):
                ...
                if header:
                    ...
                    try:
                        ...
                        logging.exception(f"Isolate with id {header_dict.get("isolate_id", "<NA>")} skipped")
    ...
    def create_isolate(self, isolate_epi):
        ...
        try:
            ...
            # print(f"{isolate_epi} except KeyError")
            return -1

        if isolate_metadata.size == 0:
            # print(f"{isolate_epi} isolate_metadata.size = 0")
            return -1
