...
get_markers_by_human_percentage = \
    ("WITH IsolatesFiltered AS ("
     ...
     "COALESCE(selectedMarkers.human_marker_count, 0) as 'Human Marker Count', "
     "selectedMarkers.total_marker_count AS 'Total Marker Count', "
